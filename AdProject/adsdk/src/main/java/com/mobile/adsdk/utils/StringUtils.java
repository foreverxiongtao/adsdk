 ...
 * 版 本 :1.0
 *
 * 创建日期 :2016/11/21  20:40
 *
 * 描 述 :字符串工具类，提供一些字符串相关的便捷方法
 *
 * 修订日期 :
 */
public class StringUtils {
    ...
    public static String replaceSpecialStr(String source, String pattern, String value) {
        String target = "";
        if (!TextUtils.isEmpty(source)) {
            try {
                target = source.replaceAll(pattern, value);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
